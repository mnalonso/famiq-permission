 ...
 * @method static bool userHasPermission(\Illuminate\Database\Eloquent\Model $user, string $permissionSlug)
...
{
    /**
     * Devuelve la clase que el facade debe resolver dentro del contenedor.
     */
